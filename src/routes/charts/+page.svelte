<script lang="ts">
    ...
    import type {ChartData} from "../../services/hiking_types.ts";
...
<div class="buttons is-centered">
    <button class="button is-link" on:click={previous}><i class="fa-solid fa-angle-left"></i></button>
    <button class="button is-link" on:click={next}><i class="fa-solid fa-angle-right"></i></button>
</div>
