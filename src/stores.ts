...
import type { Category, LoggedInUser, Hike } from './services/types.ts';
...
export const markerSelected = writable<MarkerSpec | undefined>();

export const activeCategoryStore = writable<Category>({
	hikes: [],
	userid: '',
	_id: '',
	name: 'All hikes'
